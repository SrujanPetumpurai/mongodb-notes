...
-Slower writing
## Single-Field index
Index on one field only,At Schema definition
```js
...
userSchema.index({age:1,isActive:1})//First the data structure is stored by age and then by isActive
Ex of how the index stores the data:-
age:20,isActive:true
